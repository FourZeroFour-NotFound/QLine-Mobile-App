  ...
  _renderScrollViewContent() {
    ...
    return (
      <View style={styles.scrollViewContent}>
        <View style={{ marginTop: 10, width: 200, marginLeft: 30 }}>
            <TextInput
              style={{ textAlign: 'center',height: 35, justifyContent: 'center', backgroundColor: 'white' }}
            ...
            underlayColor='transparent'>
              <View style={{marginTop: -60, marginLeft: 280, height: 10, width: 80 }}>
                <Button
